...
copy_vivado_outputs:
	...
	cp vivado1/vivado1.runs/impl_1/top.bit ./bin/top_$(shell date +%m%d)_1.bit
	cp vivado1/vivado1.gen/sources_1/bd/ps_interface/hw_handoff/ps_interface.hwh ./bin/top_$(shell date +%m%d)_1.hwh
	if [ -f vivado2/vivado2.runs/impl_1/ps_interface_wrapper.bit ]; then cp vivado2/vivado2.runs/impl_1/ps_interface_wrapper.bit ./bin/top_$(shell date +%m%d)_2.bit; fi
